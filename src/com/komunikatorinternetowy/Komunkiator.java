...
public class Komunkiator extends javax.swing.JPanel implements Serializable {
    ...
    /** Creates new form Komunkiator */

    //settery
    public void set_gniazdo(Socket gniazdo){this.gniazdo = gniazdo;}
    public void set_czytWiad(BufferedReader czytWiad){this.czytWiad = czytWiad;}
    public void set_piszWiad(PrintWriter piszWiad){this.piszWiad = piszWiad;}
    public void set_uzytkownik(String uzytkownik){this.uzytkownik = uzytkownik;}
    public void set_plikzapisu(File plikzapisu){this.plikzapisu = plikzapisu;}
    ...
    public String get_uzytkownik(){return this.uzytkownik = jTextField1.getText();}
    public File get_plikzapisu(){return this.plikzapisu = new File("zapisaneRozmowy.txt");}
    ...
    public Komunkiator() {
        ...
        initComponents();//wyrysuj komponenty dodane automatycznie

        konfigurujKomunikacje(uzytkownik);//skonfiguruj komuniacje na domyślne
        //wartości wraz z nazwą użytkownika
        
        //Tworzy wątek odbioru
    ...
    public void wyslij(){
        try{//sprobuj
                ...
                //wyslij tekst wraz z uzytkownikiem
